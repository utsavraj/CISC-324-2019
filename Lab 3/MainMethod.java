...
public class MainMethod {
  public static void main (String argv[]) {
    ...
    Synch.mutex = new Semaphore(1, true); //This semaphore is used to ensure exclusive access to the data structure between writers & writers, & between readers & writers
    Synch.OktoRead = new Semaphore(0, true);//This semaphore is used to signal a go ahead to the readers
    Synch.OktoWrite = new Semaphore(0, true);//This semaphore is used to signal a go ahead to the writers
